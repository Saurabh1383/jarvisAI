...
__all__ = [
    'SPPARTOFSPEECH', 'SVEAllEvents', 'eWORDTYPE_ADDED',
    'SPPS_Noncontent', 'SVSFNLPSpeakPunc', 'SGSExclusive',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SPARecoResult',
    'DISPID_SRRTOffsetFromStart', 'SVSFParseSsml',
    'DISPID_SPIGrammarId', 'SVP_11', 'DISPID_SPIEnginePrivateData',
    'SPSERIALIZEDPHRASE', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFTGSM610_22kHzMono', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPEDisplayText', 'SECFIgnoreCase', 'SpeechVisemeFeature',
    'eWORDTYPE_DELETED', 'SVESentenceBoundary', 'SVP_17',
    'SpPhraseInfoBuilder', 'DISPID_SRCRetainedAudio',
    'DISPID_SPAs_NewEnum', 'SVEStartInputStream', 'SP_VISEME_8',
    'ISpRecoCategory', 'DISPID_SOTSetId', 'ISpObjectWithToken',
    'SPEI_MAX_TTS', 'DISPID_SVGetProfiles', 'SPEI_TTS_PRIVATE',
    'SREHypothesis', 'DISPID_SABufferNotifySize', 'SPGS_EXCLUSIVE',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SVAudioOutput', 'SPAS_RUN',
    'eLEXTYPE_APP', 'SRTReSent', 'ISpeechLexiconWords',
    'DISPID_SVGetAudioOutputs', 'ISpStreamFormatConverter',
    'SSTTWildcard', 'SpeechPropertyComplexResponseSpeed',
    'Speech_Default_Weight', 'SAFT16kHz16BitMono', 'SP_VISEME_12',
    'DISPID_SRCRequestedUIType', 'DISPID_SRRTTickCount',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPIRule', 'SGDSInactive',
    'DISPID_SPRNumberOfElements', 'DISPID_SpeechLexiconWords',
    'DISPID_SVEWord', '__MIDL_IWinTypes_0009', 'SAFTADPCM_11kHzMono',
    'DISPID_SpeechPhraseReplacement', 'SRAExport',
    'DISPID_SpeechLexiconWord', 'SRAImport', 'SpResourceManager',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_PRIVATE7', 'SECFDefault',
    'DISPID_SGRClear', 'DISPID_SLWsCount', 'SPEI_SR_PRIVATE',
    'SpInProcRecoContext', 'DISPIDSPTSI_SelectionOffset',
    'SPRECOCONTEXTSTATUS', 'SpeechGrammarRuleStateTransitionType',
    'SVEViseme', 'DISPID_SOTId', 'SAFTCCITT_ALaw_44kHzMono',
    'SRSEDone', 'DISPID_SpeechRecognizerStatus', 'SSFMOpenReadWrite',
    'SPRST_INACTIVE', 'ISequentialStream',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTCategory',
    'DISPID_SpeechRecoResult', 'DISPID_SRGDictationUnload',
    'SRCS_Disabled', 'DISPID_SRGetRecognizers', 'SVP_18',
    'SpeechRunState', 'DISPID_SPEAudioTimeOffset', 'SRAORetainAudio',
    'DISPID_SRAudioInputStream', 'SPWORDTYPE', 'ISpeechBaseStream',
    'ISpMMSysAudio', 'SPVISEMES', 'SDTPronunciation', 'SVP_3',
    'DISPID_SRCVoice', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRGDictationLoad', 'DISPID_SRRRecoContext',
    'ISpeechAudioBufferInfo', 'SGDSActiveUserDelimited',
    'SpeechPartOfSpeech', 'SpVoice', 'DISPID_SPPsCount',
    'DISPID_SVEPhoneme', 'SpeechVoiceEvents', 'DISPID_SGRSTRule',
    'SREPhraseStart', 'DISPID_SpeechPhraseProperty',
    'DISPID_SLWLangId', 'SPVPRI_OVER', 'SPEI_SOUND_START',
    'ISpeechRecognizer', 'SPFILEMODE', 'DISPID_SBSRead',
    'DISPID_SpeechPhraseElements', 'SpeechVoiceSpeakFlags',
    'SP_VISEME_2', 'SECLowConfidence', 'eLEXTYPE_RESERVED4',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SGRInitialState', 'DISPID_SPIProperties',
    'ISpRecognizer3', 'DISPID_SOTMatchesAttributes',
    'DISPID_SDKSetStringValue', 'SDKLCurrentUser',
    'DISPID_SpeechLexiconProns', 'DISPID_SVSInputSentenceLength',
    'ISpeechRecoResult', 'SVPOver', 'DISPID_SVSLastBookmarkId',
    'SP_VISEME_3', 'SGRSTTDictation', 'SPGRAMMARSTATE',
    'DISPID_SPPValue', 'SPVPRI_ALERT', 'eLEXTYPE_PRIVATE11',
    ...
    'SWPUnknownWordUnpronounceable', 'ISpeechPhraseAlternate',
    'DISPID_SRCERecognitionForOtherContext', 'SPCT_SLEEP',
    'DISPID_SRCEHypothesis', 'DISPID_SpeechVoice',
    'DISPID_SVSpeakCompleteEvent', 'SSTTTextBuffer', 'SVEPrivate',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SAStatus', 'STCLocalServer',
    'DISPID_SLWs_NewEnum', 'SSSPTRelativeToCurrentPosition',
    'SAFT48kHz8BitMono', 'ISpeechMemoryStream',
    'SpUnCompressedLexicon', 'SVPNormal', 'SRERequestUI',
    'SPGS_DISABLED', 'DISPID_SLGetPronunciations',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechPhraseRule',
    'DISPID_SDKGetlongValue', 'SPSHORTCUTPAIRLIST', 'SVSFIsXML',
    'DISPID_SRCEventInterests', 'SP_VISEME_9', 'SLOStatic',
    ...
    'DISPID_SpeechRecoContext', 'SAFT11kHz16BitMono',
    'SECNormalConfidence', 'DISPID_SPACommit', 'DISPID_SRRAudio',
    'DISPID_SDKEnumKeys', 'SP_VISEME_13',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVP_0',
    'DISPID_SRSNumberOfActiveRules', 'SWTDeleted', 'ISpPhrase',
    'SP_VISEME_4', 'STSF_LocalAppData', 'DISPID_SPILanguageId',
    'DISPID_SPAsCount', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SRGSetTextSelection', 'DISPID_SVPriority',
    'DISPID_SRStatus', 'DISPID_SOTCGetDataKey',
    'SDA_Two_Trailing_Spaces', 'SPRECORESULTTIMES', 'SRARoot',
    'SPCONTEXTSTATE', 'SPSEMANTICERRORINFO', 'SAFT48kHz8BitStereo',
    'SREPropertyNumChange', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SRTStandard', 'DISPID_SRCEStartStream',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCERecognition',
    'DISPID_SRCEPropertyNumberChange', 'SPEI_RESERVED5',
    'SpeechGrammarState', 'SVSFParseMask',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SP_VISEME_18',
    'SPFM_CREATE', 'SVPAlert', 'DISPID_SPPId',
    'DISPID_SPEAudioStreamOffset', 'SAFTCCITT_ALaw_22kHzMono',
    'SP_VISEME_5', 'SpeechStreamFileMode', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechRetainedAudioOptions', 'SpeechEmulationCompareFlags',
    'ISpeechAudioStatus', 'DISPID_SRSetPropertyNumber', 'DISPIDSPTSI',
    'DISPID_SVEStreamEnd', 'SPPS_Interjection',
    'SPINTERFERENCE_NOISE', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SpeechPhraseRules', 'IEnumSpObjectTokens', 'SPRST_ACTIVE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SDKLCurrentConfig',
    'DISPID_SRGCmdLoadFromMemory', 'SECFIgnoreKanaType',
    'SPEI_SENTENCE_BOUNDARY', 'SpNotifyTranslator',
    'DISPID_SWFESamplesPerSec', 'SVP_6', 'ISpLexicon',
    'SAFTADPCM_44kHzStereo', 'SREStateChange',
    'SGLexicalNoSpecialChars', 'SPVOICESTATUS', 'DISPID_SPRText',
    'DISPID_SRGetFormat', 'DISPID_SGRAddState',
    'DISPID_SCSBaseStream', 'DISPID_SpeechPhraseProperties',
    'SVSFParseSapi', 'SAFTCCITT_uLaw_8kHzStereo', 'SpMMAudioEnum',
    'SpeechLexiconType', 'SPEI_END_SR_STREAM', 'DISPID_SBSFormat',
    'SpSharedRecoContext', 'SVSFVoiceMask', 'SPEI_INTERFERENCE',
    'tagSTATSTG', 'DISPID_SOTRemove', 'DISPID_SRGCmdSetRuleIdState',
    'SPSHORTCUTPAIR', 'DISPID_SVSyncronousSpeakTimeout',
    'SPRS_INACTIVE', 'SPRS_ACTIVE', 'DISPID_SASState', 'SRSActive',
    'DISPID_SRSetPropertyString', 'SpeechRecognitionType',
    'DISPID_SRRAudioFormat', 'DISPID_SPPsItem',
    'DISPID_SPRules_NewEnum', 'SPDATAKEYLOCATION',
    'SAFTGSM610_8kHzMono', 'ISpeechPhoneConverter',
    'ISpeechRecoContext', 'DISPID_SOTsCount', 'SREStreamEnd',
    'DISPID_SRGId', 'SRCS_Enabled', 'ISpeechObjectTokenCategory',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_MIN_TTS',
    'DISPID_SRRPhraseInfo', 'DISPID_SRGCmdLoadFromFile',
    'SPGRAMMARWORDTYPE', 'DISPID_SGRSTWeight',
    'DISPID_SOTGetDescription', 'ISpeechLexiconWord',
    'SVSFPersistXML', 'eLEXTYPE_PRIVATE8', 'SPLOADOPTIONS',
    'SPSHT_Unknown', 'SFTSREngine', 'ISpAudio',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechAudio', 'SBOPause',
    'SpeechDictationTopicSpelling',
    'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVAudioOutputStream', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SWFEBlockAlign', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SpeechGrammarRules', 'SITooLoud', 'SPEI_VOICE_CHANGE',
    'SDTRule', 'SpeechTokenValueCLSID', 'SRSActiveAlways',
    'SpeechTokenContext', 'SAFT44kHz8BitStereo',
    'DISPID_SVWaitUntilDone', 'DISPID_SRCEInterference',
    'SpeechVisemeType', 'SVP_10', 'SBONone', 'SAFT12kHz16BitStereo',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRSAudioStatus',
    'SAFT22kHz8BitMono', 'ISpStream', 'DISPID_SGRAttributes',
    'DISPID_SPIReplacements', 'SPWORD', 'SpeechEngineProperties',
    'SDTLexicalForm', 'SPEI_HYPOTHESIS', 'eLEXTYPE_PRIVATE18',
    'DISPID_SVSCurrentStreamNumber', 'SpInprocRecognizer',
    'DISPID_SRCEAudioLevel', 'ISpXMLRecoResult',
    'SpeechStreamSeekPositionType', 'DISPID_SVEViseme',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SVResume',
    'DISPID_SPPEngineConfidence', 'DISPID_SGRsCommitAndSave',
    'DISPID_SGRSTNextState', 'SVP_9', 'SSFMCreate', 'DISPID_SRGReset',
    'DISPID_SVDisplayUI', 'SECFNoSpecialChars',
    'SAFTNoAssignedFormat', 'SAFT32kHz16BitStereo',
    'DISPID_SPRsCount', 'IInternetSecurityMgrSite', 'ISpRecoContext',
    'SPDKL_LocalMachine', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SpFileStream', 'SVSFParseAutodetect', 'SpStreamFormatConverter',
    'DISPID_SMSADeviceId', 'SAFT44kHz16BitStereo',
    'SAFT12kHz16BitMono', 'DISPID_SRCRecognizer', 'SPVPRI_NORMAL',
    'SASStop', 'DISPID_SpeechCustomStream', 'ISpeechRecognizerStatus',
    'SAFT24kHz8BitStereo', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechAudio', 'DISPID_SRCEAdaptation',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_RESERVED10',
    'DISPID_SASCurrentDevicePosition', 'SPWF_INPUT', 'SITooFast',
    'DISPID_SVEVoiceChange', 'SpNullPhoneConverter',
    'SPWAVEFORMATTYPE', 'SPBO_TIME_UNITS', 'DISPID_SPPChildren',
    'SPSNotOverriden', 'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPIStartTime',
    'SpeechRecoContextState', 'SITooSlow', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRCState', 'SPFM_NUM_MODES',
    'DISPID_SRSSupportedLanguages', 'SpeechTokenShellFolder',
    'ISpeechPhraseInfo', 'SAFTADPCM_8kHzMono', 'ISpeechLexicon',
    'SPFM_OPEN_READONLY', 'DISPID_SRIsUISupported',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SLGetGenerationChange',
    'SVSFPurgeBeforeSpeak', 'ISpRecognizer2', 'SPEI_UNDEFINED',
    'SAFT8kHz16BitStereo', 'SpeechAudioFormatGUIDWave',
    'SPLEXICONTYPE', 'SAFT32kHz8BitMono', 'DISPID_SGRsDynamic',
    'SPXRO_SML', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRsCommit',
    'SpeechCategoryPhoneConverters', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPEPronunciation', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVRate', 'SAFTADPCM_11kHzStereo',
    'DISPID_SpeechGrammarRuleStateTransitions', 'STSF_AppData',
    'SpMMAudioIn', 'DISPID_SDKEnumValues', 'SPAO_NONE',
    'SpeechSpecialTransitionType', 'SPINTERFERENCE_TOOSLOW',
    'eLEXTYPE_PRIVATE1', 'SSSPTRelativeToEnd', 'SRAONone',
    'SAFT22kHz8BitStereo', 'SAFTCCITT_uLaw_44kHzStereo',
    'SP_VISEME_19', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRDisplayUI', 'SPTEXTSELECTIONINFO', 'ISpRecoContext2',
    'DISPID_SGRsAdd', 'ISpPhoneConverter', 'SpeechAllElements',
    'DISPID_SPELexicalForm', 'SPGS_ENABLED', 'DISPID_SWFEExtraData',
    'SVP_2', 'SpeechPropertyResponseSpeed', 'DISPID_SDKOpenKey',
    'IEnumString', 'DISPID_SLRemovePronunciation',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SPRsItem',
    'ISpeechWaveFormatEx', 'SP_VISEME_21', 'tagSPPROPERTYINFO',
    'SpeechInterference', 'SpeechLoadOption', 'DISPID_SRGRules',
    'SREAdaptation', 'SPXRO_Alternates_SML', 'SFTInput',
    'SPSHT_OTHER', 'SPCT_DICTATION', 'DISPID_SVSLastBookmark',
    'DISPID_SPRs_NewEnum', 'DISPID_SLWWord',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPEI_REQUEST_UI', 'SDTDisplayText', 'SLTUser', 'SPEI_RESERVED3',
    'DISPID_SGRSAddWordTransition', 'DISPID_SMSSetData', 'SpStream',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SGRSTType',
    'DISPID_SLWType', 'SSTTDictation', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPRECOSTATE', 'DISPID_SRCPause', 'eLEXTYPE_RESERVED7',
    'SpeechDisplayAttributes', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechVoiceEvent', 'SpeechRegistryLocalMachineRoot',
    'SPPS_Verb', 'ISpeechGrammarRuleStateTransition',
    'SpeechAudioFormatType', 'SAFTExtendedAudioFormat',
    'eLEXTYPE_PRIVATE20', 'SPCS_ENABLED', 'ISpeechPhraseProperties',
    'DISPID_SVSpeakStream', 'DISPID_SPERequiredConfidence',
    'SpeechCategoryRecoProfiles', 'SP_VISEME_16', 'SpMMAudioOut',
    'LONG_PTR', 'SPAUDIOBUFFERINFO', 'SRTEmulated', 'SPAS_CLOSED',
    'DISPID_SLPsCount', 'SASRun', 'SRSEIsSpeaking',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SPEActualConfidence', 'SAFTNonStandardFormat',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SAFGuid', 'SPINTERFERENCE_LATENCY_WARNING', 'SINoise',
    'SGLexical', 'ISpObjectToken', 'DISPID_SWFEFormatTag',
    'ISpeechGrammarRuleState', 'SpeechMicTraining',
    'DISPID_SVEBookmark', 'SAFT8kHz8BitMono',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SGRId',
    'DISPID_SpeechWaveFormatEx', 'SVP_13', 'eLEXTYPE_PRIVATE16',
    'SpeechPropertyHighConfidenceThreshold', 'SPVPRIORITY',
    'DISPID_SPANumberOfElementsInResult', 'SAFT24kHz8BitMono',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPRuleConfidence',
    'SpShortcut', 'SPDKL_CurrentConfig', 'SpeechCategoryRecognizers',
    'DISPID_SVIsUISupported', 'SRTAutopause', 'ISpeechAudioFormat',
    'DISPID_SpeechAudioStatus', 'SDA_Consume_Leading_Spaces',
    'SpeechRegistryUserRoot', 'ISpeechObjectTokens',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPRECOGNIZERSTATUS',
    'DISPID_SRProfile', 'DISPID_SRCreateRecoContext',
    'SPEI_TTS_BOOKMARK', 'eLEXTYPE_MORPHOLOGY', 'ISpeechPhraseRule',
    'SP_VISEME_7', 'SpCustomStream', 'SDA_No_Trailing_Space',
    'SPSHT_EMAIL', 'SVEEndInputStream', 'SAFT11kHz8BitStereo',
    'DISPID_SRCESoundEnd', 'ISpeechFileStream', 'SPEI_MIN_SR',
    'SGDSActiveWithAutoPause', 'DISPID_SVEAudioLevel',
    'DISPID_SpeechPhoneConverter', 'ISpeechMMSysAudio',
    'SpTextSelectionInformation', 'ISpeechVoiceStatus',
    'DISPID_SPCLangId', 'SPCT_COMMAND', 'DISPID_SVVoice',
    'SPSInterjection', 'DISPID_SVStatus', 'SPBINARYGRAMMAR',
    'DISPID_SPEEngineConfidence', 'SAFTCCITT_uLaw_22kHzMono',
    'SGSEnabled', 'SPCT_SUB_COMMAND', 'STCInprocServer', 'SPBO_PAUSE',
    'eLEXTYPE_USER_SHORTCUT', 'SASClosed', 'SRSInactiveWithPurge',
    'SPEVENT', 'Speech_StreamPos_RealTime', 'SPPS_LMA',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechTokenKeyAttributes',
    'SPSHT_NotOverriden', 'SpSharedRecognizer', 'SAFTDefault',
    'SAFT44kHz16BitMono', 'SPSTREAMFORMATTYPE', 'SPEI_PHRASE_START',
    'SPSSuppressWord', 'DISPID_SABIBufferSize',
    'SpeechGrammarWordType', 'DISPID_SLPLangId', 'SPPHRASEPROPERTY',
    'SGRSTTWord', 'DISPIDSPTSI_ActiveLength', 'DISPID_SRCResume',
    'ISpeechTextSelectionInformation', 'SPINTERFERENCE_NONE',
    'SPAO_RETAIN_AUDIO', 'SpeechCategoryVoices',
    'SAFTADPCM_22kHzMono', 'SpeechPropertyNormalConfidenceThreshold',
    'eLEXTYPE_PRIVATE9', 'SINone', 'SAFT12kHz8BitStereo',
    'DISPID_SPRulesItem', '_RemotableHandle',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRSCurrentStreamNumber',
    'SDA_One_Trailing_Space', 'DISPID_SOTDataKey',
    'SAFT44kHz8BitMono', 'DISPID_SVSpeak', 'SSFMCreateForWrite',
    'SP_VISEME_17', 'SpeechAudioVolume', 'ISpRecognizer',
    'SAFT24kHz16BitMono', 'SECFIgnoreWidth', 'SPPHRASEREPLACEMENT',
    'ISpeechGrammarRuleStateTransitions', 'ISpeechPhraseReplacements',
    'ISpeechXMLRecoResult', 'SPEI_START_SR_STREAM',
    'DISPID_SOTCreateInstance', 'DISPID_SPEs_NewEnum',
    'SAFT32kHz8BitStereo', 'DISPID_SDKDeleteKey', 'SSFMOpenForRead',
    'SREAudioLevel', 'DISPID_SVEventInterests', 'SVSFIsFilename',
    'IInternetSecurityManager', 'SVP_14', 'SP_VISEME_14', 'SVP_7',
    'ISpeechPhraseElements', 'eLEXTYPE_PRIVATE4',
    'ISpeechRecoResult2', 'ISpeechDataKey', 'DISPID_SOTDisplayUI',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVSInputWordPosition',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRSaveToMemory',
    'SPSERIALIZEDRESULT', 'SpeechTokenIdUserLexicon',
    'SSSPTRelativeToStart', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPIAudioStreamPosition', 'SpWaveFormatEx',
    'DISPID_SpeechRecognizer', 'SPPS_Unknown', 'SPPHRASEELEMENT',
    'SRTExtendableParse', 'DISPID_SPCIdToPhone', 'SLODynamic',
    'SPEI_SR_BOOKMARK', 'SpeechTokenKeyUI', 'ISpNotifySink',
    'SDTReplacement', 'SPSVerb', '_SPAUDIOSTATE',
    'DISPID_SpeechRecoResult2', 'ISpEventSource',
    'DISPID_SPPs_NewEnum', 'DISPID_SLWPronunciations',
    'SRTSMLTimeout', 'DISPID_SRCEEndStream', 'SPFM_CREATE_ALWAYS',
    'SGRSTTRule', 'STCInprocHandler', 'DISPID_SPRuleChildren',
    'SPPS_RESERVED3', 'SPSLMA', 'SAFTADPCM_44kHzMono',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRGCommit', 'DISPID_SPAsItem',
    'SVSFIsNotXML', 'SPBO_AHEAD', 'ISpeechPhraseAlternates',
    'SPWT_LEXICAL', 'SREStreamStart', 'IStream', 'DISPID_SPEsCount',
    'DISPID_SGRName', 'ISpeechLexiconPronunciations', 'SPLO_STATIC',
    'SpeechCategoryAppLexicons', 'DISPID_SGRSTPropertyValue',
    'SPEI_RECOGNITION', 'ISpRecoResult', 'SPSEMANTICFORMAT',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SLPs_NewEnum',
    'SpeechPropertyResourceUsage', 'STSF_CommonAppData',
    'DISPID_SWFEChannels', 'ISpPhoneticAlphabetSelection',
    'DISPID_SRCESoundStart', 'DISPID_SVGetVoices',
    'SpeechRecognizerState', 'ISpeechPhraseRules',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPRulesCount',
    'DISPID_SOTsItem', 'DISPID_SpeechGrammarRuleState',
    'SpeechDataKeyLocation', 'SVP_1', 'SVP_5', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE17',
    'DISPID_SADefaultFormat', 'SpeechGrammarTagDictation',
    'SPADAPTATIONRELEVANCE', 'DISPID_SFSClose', 'SPWT_DISPLAY',
    'ISpeechObjectToken', 'SVF_Stressed', 'ISpRecoGrammar2',
    'DISPID_SPIAudioSizeTime', 'SRADynamic', 'SECHighConfidence',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPRULESTATE',
    'SPINTERFERENCE_TOOFAST', 'SREPropertyStringChange',
    'DISPID_SpeechObjectToken', 'SRERecognition',
    'DISPID_SRGetPropertyString', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechRecoContextEvents',
    'eLEXTYPE_PRIVATE13', 'ISpEventSink', 'SP_VISEME_15',
    'SPPHRASERULE', 'DISPID_SFSOpen', 'SPPS_Function',
    'DISPID_SRAudioInput', 'eLEXTYPE_PRIVATE2', 'DISPID_SGRSTsCount',
    'SP_VISEME_6', 'ISpDataKey', 'ISpeechGrammarRules',
    'DISPID_SVEStreamStart', 'DISPID_SPPConfidence',
    'DISPID_SPRuleName', 'SpeechAudioFormatGUIDText',
    'SAFTCCITT_uLaw_8kHzMono', 'SGSDisabled',
    'DISPID_SpeechPhraseElement', 'SpeechRecoProfileProperties',
    'DISPID_SVSRunningState', 'SPWORDPRONUNCIATION',
    'DISPID_SOTGetAttribute', 'SpAudioFormat',
    'DISPID_SRCCmdMaxAlternates', '_ISpeechRecoContextEvents',
    'DISPID_SRCEPropertyStringChange', 'SREFalseRecognition',
    'DISPID_SLPSymbolic', 'SPAUDIOOPTIONS', 'SVP_21',
    'DISPID_SLPPhoneIds', 'DISPID_SGRSAddSpecialTransition',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTs_NewEnum',
    'DISPID_SABIEventBias', 'DISPID_SVSPhonemeId', 'SVF_None',
    'ISpeechPhraseReplacement', 'DISPID_SVGetAudioInputs',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpResourceManager',
    'SAFT24kHz16BitStereo', 'SVF_Emphasis', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechDataKey', 'DISPID_SABIMinNotification',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRGCmdLoadFromObject',
    'SpeechCategoryAudioOut', 'DISPID_SPEsItem',
    'tagSPTEXTSELECTIONINFO', 'SpeechVoicePriority', 'SVSFlagsAsync',
    'SVEWordBoundary', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpRecoGrammar',
    'SPEI_END_INPUT_STREAM', 'ISpeechRecoGrammar', 'SPAS_PAUSE',
    ...
    'SGRSTTWildcard', 'SAFT8kHz8BitStereo', 'SPSModifier',
    'SPPS_RESERVED1', 'DISPID_SMSAMMHandle', 'DISPID_SPIElements',
    'SpeechAudioProperties', 'SP_VISEME_1',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRIsShared',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SMSGetData',
    'DISPID_SDKGetStringValue', 'DISPID_SPRuleParent',
    'DISPID_SGRAddResource', 'DISPID_SOTIsUISupported',
    'SpObjectToken', 'DISPID_SVEEnginePrivate', 'SVEAudioLevel',
    'ISpeechCustomStream', 'SPEI_VISEME', 'SPSFunction',
    'DISPID_SGRSTsItem', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SAFType',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpeechRecoResultTimes',
    'ISpPhraseAlt', 'SPWT_PRONUNCIATION', 'DISPID_SRRTimes',
    'SpeechCategoryAudioIn', 'DISPID_SRSCurrentStreamPosition',
    'SPSMF_UPS', 'SPCS_DISABLED', 'SDKLDefaultLocation',
    'DISPID_SASCurrentSeekPosition', 'SP_VISEME_11',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGIsPronounceable',
    'SPXMLRESULTOPTIONS', 'DISPID_SGRSTPropertyId', 'SVEPhoneme',
    'DISPID_SGRsFindRule', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SVVolume', 'DISPID_SLPPartOfSpeech', 'SpeechDiscardType',
    'SPSHORTCUTTYPE', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFT16kHz8BitMono', 'ISpeechLexiconPronunciation',
    'SPEI_RESERVED6', 'SGPronounciation',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechPhraseInfo',
    'DISPID_SOTCSetId', 'SGRSTTEpsilon', 'DISPID_SPISaveToMemory',
    'SVSFDefault', 'eLEXTYPE_PRIVATE15',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPAUDIOSTATE',
    'DISPID_SPEDisplayAttributes', 'SVP_15', 'DISPID_SRGRecoContext',
    'DISPID_SPEAudioSizeTime', 'DISPID_SOTRemoveStorageFileName',
    'SAFT16kHz8BitStereo', 'SRSInactive', 'STCAll',
    'SAFTGSM610_11kHzMono', 'STCRemoteServer', 'SAFT12kHz8BitMono',
    'SLTApp', 'DISPID_SREmulateRecognition', 'SRERecoOtherContext',
    'SpeechBookmarkOptions', 'SPSNoun', 'SINoSignal',
    'DISPID_SPPFirstElement', 'SPEI_TTS_AUDIO_LEVEL',
    'SPINTERFERENCE_TOOQUIET', 'SAFT11kHz8BitMono', 'SREInterference',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SVSVisemeId',
    'SECFEmulateResult', 'SAFT16kHz16BitStereo', 'DISPID_SPPName',
    'SAFT11kHz16BitStereo', 'SPEVENTSOURCEINFO', 'eLEXTYPE_RESERVED6',
    'SP_VISEME_20', 'eLEXTYPE_PRIVATE14', 'ISpeechResourceLoader',
    'SGDSActive', 'SPDKL_CurrentUser', 'SPWORDPRONUNCIATIONLIST',
    'SPEVENTENUM', 'SPPS_NotOverriden', 'DISPID_SRRSpeakAudio',
    'SPAR_Unknown', 'SPPHRASE', 'SVP_12', 'SPRULE', 'DISPID_SVPause',
    'SpeechTokenKeyFiles', 'SPPS_RESERVED2', 'DISPID_SGRs_NewEnum',
    'SPCATEGORYTYPE', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCEPhraseStart', 'SpLexicon', 'DISPID_SBSSeek',
    'DISPID_SLAddPronunciation', 'SVP_16', 'ISpNotifyTranslator',
    'SWTAdded', 'DISPIDSPRG', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SPCPhoneToId', 'SAFT8kHz16BitMono', 'SpeechRuleState',
    'SpeechEngineConfidence', 'SPLO_DYNAMIC', 'SRADefaultToActive',
    'DISPID_SpeechFileStream', 'SpeechWordType', 'SRESoundStart',
    'ISpeechPhraseInfoBuilder', 'DISPID_SLPType', 'SPEI_MAX_SR',
    'DISPID_SAEventHandle', 'SPINTERFERENCE', 'DISPID_SMSALineId',
    'SPCT_SUB_DICTATION', 'SAFT48kHz16BitStereo', 'DISPID_SAVolume',
    'ISpSerializeState', 'DISPID_SRCEBookmark', 'DISPID_SGRSRule',
    'DISPID_SPRFirstElement', 'SWPUnknownWordPronounceable',
    'SPWF_SRENGINE', 'WAVEFORMATEX', 'ISpVoice',
    'SpCompressedLexicon', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SOTCDefault', 'eLEXTYPE_PRIVATE19',
    'ISpeechPhraseProperty', 'SAFT48kHz16BitMono', 'SPBO_NONE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLWsItem', 'SPEI_RESERVED1', 'DISPID_SRState',
    'SPPS_Modifier', 'SPRST_ACTIVE_ALWAYS', 'SpeechFormatType',
    'SVP_4', 'SWPKnownWordPronounceable', 'SVP_20',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTText',
    'eLEXTYPE_PRIVATE6', 'SRAInterpreter', 'SAFT22kHz16BitMono',
    'SDTProperty', 'SPPS_RESERVED4', 'SpeechGrammarTagWildcard',
    'SDTAudio', 'eLEXTYPE_USER', 'DISPID_SLGenerationId',
    'DISPID_SRGetPropertyNumber', 'SPPS_Noun', 'SGRSTTTextBuffer',
    'SpeechRuleAttributes', 'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE10',
    'SPFM_OPEN_READWRITE', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SASetState', 'SRESoundEnd', 'DISPID_SpeechBaseStream',
    'DISPID_SRRecognizer', 'SVSFNLPMask', 'SREPrivate',
    'SpeechPropertyAdaptationOn', 'SDTAlternates',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SRCBookmark',
    'SAFT32kHz16BitMono', 'ISpNotifySource', '_ISpeechVoiceEvents',
    'STSF_FlagCreate', 'ISpProperties', 'ISpStreamFormat', 'SPAR_Low',
    'SPWORDPRONOUNCEABLE', 'SAFT22kHz16BitStereo',
    'DISPID_SPIRetainedSizeBytes', 'SDTAll',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SLPsItem', 'ISpShortcut',
    'SGDisplay', 'SVSFUnusedFlags', 'DISPID_SASNonBlockingIO',
    'DISPID_SASFreeBufferSpace', 'DISPID_SRRGetXMLResult',
    'SREBookmark', 'SpPhoneConverter', 'SAFTGSM610_44kHzMono',
    'SPEI_START_INPUT_STREAM', 'DISPID_SpeechAudioFormat',
    'DISPID_SGRSTText', 'DISPID_SRCEEnginePrivate', 'SPEI_ADAPTATION',
    'eLEXTYPE_RESERVED9', 'DISPID_SRRAlternates', 'DISPID_SGRsCount',
    'SRATopLevel', 'SVP_8', 'DISPID_SRRTLength',
    'DISPID_SDKSetLongValue', 'DISPID_SRCAudioInInterferenceStatus',
    'SPAR_Medium', 'ISpeechGrammarRule', 'SpeechAddRemoveWord',
    'DISPID_SDKCreateKey', 'SPAR_High', 'SPEI_PHONEME',
    'SPEI_RESERVED2', 'DISPID_SGRsItem', 'SVP_19', 'SPAS_STOP',
    'SPDKL_DefaultLocation', 'SAFTADPCM_8kHzStereo',
    'ISpGrammarBuilder', 'SPEI_WORD_BOUNDARY',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechObjectTokens',
    'DISPID_SpeechAudioBufferInfo', 'SREAllEvents',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SVSLastResult',
    'SPWORDLIST', 'ISpeechPhraseElement', 'SDKLLocalMachine',
    'DISPID_SRGState', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SDKDeleteValue',
    'SpMemoryStream', 'DISPID_SPIEngineId', 'SpObjectTokenCategory',
    'SASPause', 'DISPID_SpeechLexicon', 'eLEXTYPE_RESERVED8',
    'ISpeechVoice', 'DISPID_SWFEBitsPerSample',
    'DISPID_SPRuleFirstElement', 'SPPS_SuppressWord', 'UINT_PTR',
    'DISPID_SPIGetText', 'SPSUnknown', 'Speech_Max_Pron_Length',
    'DISPID_SRSClsidEngine', 'DISPID_SGRSTransitions', 'SITooQuiet',
    'SpeechAudioState', 'DISPID_SVAlertBoundary', 'SVEBookmark',
    'DISPID_SpeechMemoryStream', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SLGetWords', 'Speech_StreamPos_Asap', 'SPPROPERTYINFO',
    'DISPID_SRCERequestUI', 'DISPID_SGRSTPropertyName',
    'SPEI_SOUND_END', 'DISPID_SVSkip', 'SPRST_NUM_STATES',
    'SP_VISEME_10', 'DISPID_SRCCreateResultFromMemory',
    'SpeechRecoEvents', 'ISpObjectTokenCategory',
    'ISpPhoneticAlphabetConverter', 'SpeechUserTraining',
    'DISPID_SOTCEnumerateTokens', 'SVEVoiceChange'
]
